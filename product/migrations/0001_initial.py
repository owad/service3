    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('komentarz', 'komenatrz'), ('zmiana_statusu', 'zmiana statusu'), ('sprzet', 'sprzęt')], verbose_name='typ', max_length=32)),
                ('status', models.CharField(choices=[('przyjety', 'przyjęty'), ('w_realizacji', 'w realizacji'), ('do_wyslania', 'do wysłania'), ('w_serwisie', 'w serwisie zew.'), ('z_serwisu', 'odebrano z serwisu zew.'), ('do_wydania', 'do wydania'), ('wydany', 'wydany')], max_length=32, blank=True)),
                ('hardware', models.DecimalField(max_digits=10, decimal_places=2, verbose_name='koszt sprzętu', default='0.00')),
                ('software', models.DecimalField(max_digits=10, decimal_places=2, verbose_name='koszt usługi', default='0.00')),
                ('transport', models.DecimalField(max_digits=10, decimal_places=2, verbose_name='koszt dojazdu', default='0.00')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('przyjety', 'przyjęty'), ('w_realizacji', 'w realizacji'), ('do_wyslania', 'do wysłania'), ('w_serwisie', 'w serwisie zew.'), ('z_serwisu', 'odebrano z serwisu zew.'), ('do_wydania', 'do wydania'), ('wydany', 'wydany')], max_length=32)),
                ('parcel_number', models.CharField(max_length=64, verbose_name='numer przesyłki', blank=True)),
                ('external_service_name', models.CharField(max_length=128, verbose_name='nazwa serwisu zewnętrznego', blank=True)),
                ('max_cost', models.DecimalField(max_digits=10, decimal_places=2, verbose_name='koszt naprawy do', default='0.00')),
                ('warranty', models.CharField(choices=[('N', 'Nie'), ('Y', 'Tak')], verbose_name='gwarancja', max_length=16)),
